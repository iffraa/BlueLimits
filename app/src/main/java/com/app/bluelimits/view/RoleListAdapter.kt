...
class RoleListAdapter(val roleList: ArrayList<Resort>) :
    ...
    override fun onBindViewHolder(holder: RoleViewHolder, position: Int) {
        ...
        holder.view.btnRole.setOnClickListener(View.OnClickListener {
            val action = ResortFacilitiesFragmentDirections.actionResortFacilitiesFragToUnitFormFragment(resort,roleList.get(position))
